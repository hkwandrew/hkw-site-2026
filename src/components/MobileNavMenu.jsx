...
const Overlay = styled.div`
    ...
    background:
        radial-gradient(circle at 88% 14%, rgba(208, 71, 27, 0.18) 0 48px, transparent 49px),
        linear-gradient(180deg, rgba(252, 250, 229, 0.99) 0%, rgba(252, 250, 229, 0.97) 58%, rgba(175, 211, 252, 0.95) 100%);
...
const MenuLabel = styled.div`
    ...
    font-variation-settings: 'wdth' 75, 'wght' ${({ theme }) => theme.font.weight.bold};
...
const MenuLink = styled(NavLink)`
    ...
    text-transform: uppercase;
    font-variation-settings: 'wdth' 75, 'wght' ${({ theme }) => theme.font.weight.medium};
    color: ${({ theme }) => theme.colors.blue.dark};
