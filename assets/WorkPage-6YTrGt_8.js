...
`,kt=({$state:t})=>t===`leaving`?e`
    ...
    opacity: 1;
    z-index: 2;
  `,$=(e,t)=>e==null||e===``?t:typeof e==`number`?`${e}px`:e,At=(e,t)=>e===void 0?t:typeof e==`number`?`${e}deg`:e,jt=e=>$(e,`auto`),Mt=n(u)`
  overflow: hidden;
...
`,Wt=n(n.div`
  ...
  @media (max-width: ${({theme:e})=>e.breakpoints.mobile}) {
    ...
    img {
      ...
      object-fit: contain;
      transform: none;
      translate: ${({$layout:e})=>$(e?.viewports?.mobile?.x,`0`)}
        ${({$layout:e})=>$(e?.viewports?.mobile?.y,`0`)};
    }
  }
`)`
  ${kt}
